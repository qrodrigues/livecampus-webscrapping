...
conn = "postgres://course_pyth_8214:WCCU-NNiG777z2cwDPIp@course-pyth-8214.postgresql.a.osc-fr1.scalingo-dbs.com:33810/course_pyth_8214?sslmode=prefer"url = "/calendrier_des_series.html" + "?date=2023-10" # ?date=2023-10 n'est pas obligatoire mais il permet d'assurer le mois d'octobre.
...
pgsql.drop_tables()
print("Table duration et episode supprimées avec succès")
pgsql.save_to_postgres(episodes)

#SQLite3
sqlite = SQLiteManager(episodes, conn)
